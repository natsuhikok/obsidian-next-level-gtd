...
const en: PluginStrings = {
	openFileViewRibbon: 'Open GTD Files',
	openFileViewCommand: 'Open Files',
	...
	settingExcludedFoldersSectionDesc:
		'Notes in these folders are ignored by Files view and Initialize.',
	...
	noFilesInSelectedTab: 'No matching files.',
	openNote: 'Open',
...
const ja: PluginStrings = {
	openFileViewRibbon: 'GTD ファイルを開く',
	openFileViewCommand: 'ファイルを開く',
	...
	noFilesInSelectedTab: '一致するファイルはありません。',
	openNote: '開く',
